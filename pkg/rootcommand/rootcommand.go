...
func GetRootCommand() *cobra.Command {
	...
	rootCmd := &cobra.Command{
		Use:           build.AppName,
		Short:         build.AppName + " is the command-line interface to Intility Build.",
		Long:          ``,
		Run:           showHelp,
		SilenceErrors: true,
	}
...
func getAccountCommand(set clientset.ClientSet) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "account",
		Short: "Manage your Intility Build account",
		Long:  `Manage your Intility Build account`,
		Run:   showHelp,
	}
...
func getTeamsCommand(set clientset.ClientSet) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "team",
		Short: "Manage Intility Build teams",
		Long:  "Manage Intility Build teams",
		Run:   showHelp,
	}
...
func getMemberCommand(set clientset.ClientSet) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "member",
		Short: "Manage Intility Build team members",
		Long:  "Manage Intility Build team members",
		Run:   showHelp,
	}
...
func getUserCommand(set clientset.ClientSet) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "user",
		Short: "Manage Intility Build users",
		Long:  "Manage Intility Build users",
		Run:   showHelp,
	}
...
func getPullSecretCommand(set clientset.ClientSet) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "pullsecret",
		Short: "Manage Intility Kubernetes image pull secrets",
		Long:  "Manage Intility Kubernetes image pull secrets",
		Run:   showHelp,
	}
