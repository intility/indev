...
const (
	...
	// skipCallers is the number of stack frames to skip when capturing a stack
	// 0 identifies the callers frame and 1 identifies the caller of the caller.
	skipCallers = 2
)
...
func Errorf(format string, a ...any) error {
	...
	n := runtime.Callers(skipCallers, safeErr.callers)
